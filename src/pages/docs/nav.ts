...
export const NAV: NavGroup[] = [
    ...
    items: [
      ...
      },
      {
        ...
        toc: [
          ...
          { id: "apply", label: "apply", ru: "apply" },
          { id: "service", label: "service", ru: "service" },
    ...
    items: [
      ...
      },
      {
        ...
        toc: [
          ...
          { id: "grafana", label: "Grafana / Loki", ru: "Grafana / Loki" },
          { id: "otlp", label: "OTLP export", ru: "Экспорт OTLP" },
        ],
      },
      {
        id: "metrics-logs",
        ...
        toc: [
          ...
          { id: "prometheus-export", label: "Prometheus export", ru: "Экспорт Prometheus" },
          { id: "loki-export", label: "Loki export", ru: "Экспорт Loki" },
        ],
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        ...
        toc: [
          ...
          { id: "obsexport", label: "Observability export", ru: "Экспорт observability" },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: "availability",
        label: "Availability & Upgrades",
        ru: "Доступность и обновления",
        toc: [
          { id: "upgrade-window", label: "Upgrade window", ru: "Окно обновления" },
          { id: "degradation", label: "Degradation by capability", ru: "Деградация по возможностям" },
          { id: "mitigations", label: "Built-in mitigations", ru: "Встроенные смягчения" },
          { id: "boundaries", label: "Model boundaries", ru: "Границы модели" },
          { id: "operator-guidance", label: "Operator guidance", ru: "Рекомендации оператору" },
        ],
      },
      {
        id: "sb-apply",
        label: "GitOps & sb apply",
        ru: "GitOps и sb apply",
        toc: [
          { id: "why-apply", label: "Why apply", ru: "Зачем apply" },
          { id: "manifest", label: "services.yaml", ru: "services.yaml" },
          { id: "semantics", label: "Apply semantics", ru: "Семантика apply" },
          { id: "keys-ci", label: "Keys & CI", ru: "Ключи и CI" },
          { id: "export", label: "sb service export", ru: "sb service export" },
        ],
      },
    ],
  },
