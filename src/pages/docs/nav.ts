...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "testing-handlers",
        label: "Testing Handlers",
        ru: "Тестирование хендлеров",
        toc: [
          { id: "overview", label: "Why", ru: "Зачем" },
          { id: "install", label: "Install & import", ru: "Установка и импорт" },
          { id: "model", label: "Model", ru: "Модель" },
          { id: "rpc-handle", label: "RPC handler", ru: "RPC-хендлер" },
          { id: "rpc-mock", label: "Outbound RPC mocks", ru: "Моки исходящих RPC" },
          { id: "event-handle", label: "Event handler", ru: "Event-хендлер" },
          { id: "event-retry", label: "Modeling a retry", ru: "Моделирование повтора" },
          { id: "event-publish", label: "Outbound event publish", ru: "Исходящая публикация" },
          { id: "factory-pattern", label: "Testable handler factory", ru: "Тестируемая фабрика" },
          { id: "boundaries", label: "What it doesn't do", ru: "Чего не делает" },
          { id: "cheatsheet", label: "Cheat sheet", ru: "Шпаргалка" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        ru: "Роли консоли",
        toc: [
          { id: "schema", label: "Schema & default", ru: "Схема и умолч." },
          { id: "enforcement", label: "How it's enforced", ru: "Как проверяется" },
          { id: "self-account", label: "Self-account exception", ru: "Исключение для себя" },
          { id: "gated-domains", label: "Gated domains", ru: "Закрытые домены" },
          { id: "console-ui", label: "Console UI", ru: "UI консоли" },
          { id: "cli", label: "CLI", ru: "CLI" },
          { id: "limits", label: "Limits", ru: "Границы" },
        ],
      },
      {
        id: "tls-mtls",
      ...
      },
      {
        ...
        toc: [
          { id: "what-to-backup", label: "What to backup", ru: "Что бэкапить" },
          { id: "pitr-recipe", label: "PITR recipe", ru: "Рецепт PITR" },
          { id: "restore-semantics", label: "Restore semantics", ru: "Семантика восстановления" },
          { id: "ca-warning", label: "The CA warning", ru: "Предупреждение про CA" },
          { id: "ca-rotation", label: "CA rotation", ru: "Ротация CA" },
        ],
      },
      {
        id: "sb-apply",
      ...
      {
        id: "capacity",
        label: "Capacity & Benchmarks",
        ru: "Производительность и бенчмарки",
        toc: [
          { id: "methodology", label: "Methodology", ru: "Методология" },
          { id: "measured-numbers", label: "Measured numbers", ru: "Измеренные цифры" },
          { id: "caveats", label: "Honest caveats", ru: "Честные оговорки" },
          { id: "thousand-services", label: "The 1000-services claim", ru: "Заявление про 1000 сервисов" },
          { id: "rpc-overhead", label: "The RPC overhead claim", ru: "Заявление про накладные расходы RPC" },
          { id: "sizing", label: "Sizing table", ru: "Sizing-таблица" },
          { id: "summary", label: "Summary", ru: "Итог" },
        ],
      },
    ],
  },
