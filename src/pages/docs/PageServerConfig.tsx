...
export function PageServerConfig() {
  return (
    <div>
      ...
      <EnvTable
        rows={[
          { name: "SERVICEBRIDGE_RETENTION_DAYS", default: "3", desc: "Delete runs and traces older than N days. Set 0 to disable deletion." },
          { name: "SERVICEBRIDGE_RETAIN_SUCCESS_RUNS", default: "true", desc: "Keep successful runs in history." },
          { name: "SERVICEBRIDGE_RETAIN_ERROR_RUNS", default: "true", desc: "Keep failed runs in history." },
          { name: "SERVICEBRIDGE_RETENTION_INTERVAL_MIN", default: "60", desc: "How often the cleanup worker runs (minutes)." },
          { name: "SERVICEBRIDGE_LOGS_ENABLED", default: "true", desc: "Enable log ingestion (Loki-compatible endpoint)." },
          { name: "SERVICEBRIDGE_LOGS_TTL_DAYS", default: "3", desc: "Delete logs older than N days." },
        ]}
      />
      ...
      <EnvTable
        rows={[
          { name: "SERVICEBRIDGE_ADMIN_SESSION_TTL_MS", default: "86400000", desc: "Admin session lifetime in ms. Default: 24 hours." },
          { name: "SERVICEBRIDGE_ENV", default: "development", desc: 'Environment: "development" or "production". Production enforces HTTPS and blocks default credentials.' },
        ]}
      />
      ...
      <EnvTable
        rows={[
          { name: "SERVICEBRIDGE_PG_POOL_MAX", default: "20", desc: "Max PostgreSQL connections in the pool." },
          ...
          { name: "SERVICEBRIDGE_JOBS_CONCURRENCY", default: "50", desc: "Parallel cron job workers." },
          { name: "SERVICEBRIDGE_RATE_LIMIT_RPS", default: "0", desc: "HTTP rate limit (requests/sec per IP). 0 = disabled." },
        ]}
      />
      ...
      <EnvTable
        rows={[
          ...
          { name: "GET /ready", desc: "Returns 200 OK when database is reachable, 503 otherwise. Use for readiness probes." },
