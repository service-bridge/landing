...
const METRIC_GROUPS = [
  {
    label: "RPC",
    tone: "text-blue-400",
    metrics: ["rpc_calls_total", "rpc_duration_p95_ms", "rpc_duration_p99_ms", "rpc_error_rate"],
  },
  {
    label: "Events",
    tone: "text-emerald-400",
    metrics: ["queue_messages_total", "deliveries_total", "dlq_depth", "delivery_duration_p99_ms"],
  },
  {
    label: "Jobs",
    tone: "text-amber-400",
    metrics: ["jobs_registered", "job_executions_total", "job_duration_p99_ms"],
  },
  {
    label: "Workflows",
    tone: "text-fuchsia-400",
    metrics: ["workflow_runs_total", "workflow_duration_p99_ms"],
  },
  {
    label: "Resources",
    tone: "text-cyan-400",
    metrics: ["cpu_percent", "ram_mb", "db_size_mb", "active_sessions"],
  },
  {
    label: "Traces",
    tone: "text-violet-400",
    metrics: ["traces_total", "trace_error_rate", "traces_24h"],
  },
] as const;
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="type-body-sm text-muted-foreground mt-0.5">
                  Metrics computed on each scrape (15s cache). Logs stored with 3-day default
                  retention.
                </p>
              </div>
            </div>
      ...
      cards={
        <>
          <FeatureCard
            ...
            description="RPC, events, jobs, workflows, traces, resources, logs — all in one /metrics endpoint."
          ...
          <FeatureCard
            ...
            description="SDK patches console.log / log / slog automatically. No Promtail, no FluentBit, no log shipper."
          ...
          <FeatureCard
            ...
            description="Logs carry trace_id and span_id. Expand any span in the waterfall to see correlated log lines."
          ...
          <FeatureCard
            ...
            description="Metrics, logs, and traces all in PostgreSQL. Standard backups, no separate time-series DB."
