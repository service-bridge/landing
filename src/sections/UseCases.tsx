...
function StreamDiagram() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex justify-center gap-1.5 flex-wrap">
        <Badge tone="text-sky-400 bg-sky-400/10 border-sky-400/20">0 proxy hops</Badge>
        <Badge tone="text-cyan-400 bg-cyan-400/10 border-cyan-400/20">cancel on disconnect</Badge>
  ...
  return (
    <div className="space-y-0">
      ...
      <div className="flex justify-center gap-1.5 flex-wrap pt-4">
        ...
        <Badge tone="text-orange-400 bg-orange-400/10 border-orange-400/20">catchup policy</Badge>
...
function AlertsDiagram() {
  ...
  return (
    <div className="space-y-0">
      ...
      <div className="flex justify-center gap-1.5 flex-wrap pt-4">
        <Badge tone="text-red-400 bg-red-400/10 border-red-400/20">8 condition types</Badge>
