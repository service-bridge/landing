...
const SDK_TABS = [{ id: "node" as const, label: "Node" }];
      ...
      <motion.div variants={fadeInUp} className="mt-16 grid gap-8 max-w-3xl mx-auto">
        ...
        <div className="flex gap-6">
          ...
          <div className="pb-8 flex-1 min-w-0">
            ...
            <p className="type-body-sm mb-4">
              One command sets up ServiceBridge + PostgreSQL via Docker Compose, opens the console
              to create your admin account, and exports the control-plane CA to{" "}
        ...
        <div className="flex gap-6">
          ...
          <div className="pb-8 flex-1 min-w-0">
            ...
            <p className="type-body-sm mb-4">
              Register RPC handlers, subscribe to events, and call other services. Pass your
              service&apos;s bootstrap key to the constructor — the{" "}
              <code>sb.&lt;base64url-payload&gt;</code> token embeds the key id, secret, and
              control-plane CA.
            </p>
            <div className="rounded-2xl border border-surface-border bg-code overflow-hidden">
              <div className="border-b border-surface-border bg-code-chrome px-3 py-2 flex items-center justify-between">
            ...
            <p className="type-caption mt-3 text-muted-foreground/80">
              Control-plane trust is read from the CA embedded in the <code>sb.</code> key. On{" "}
              <code>start()</code>, the SDK generates a local ECDSA P-256 key pair and sends only the
              public key to provision the worker mTLS cert.
            </p>
          </div>
        </div>
      </motion.div>
