...
const HERO_STATS = [
  ...
  { icon: ShieldCheck, title: "TLS by default", desc: "auto-provisioned certs from a key" },
  { icon: Activity, title: "Durable events", desc: "at-least-once, retries & DLQ" },
  { icon: Layers, title: "Up to 1000 services", desc: "single runtime instance" },
  { icon: RefreshCw, title: "Offline outbox", desc: "publishes survive runtime outages" },
] as const;
  ...
  return (
    <Section className="relative overflow-hidden pb-20 pt-32 lg:pb-32 lg:pt-44 border-t-0">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        >
          Direct mTLS RPC between workers with no proxy hop. Durable events and cron/delayed jobs,
          DAG workflows, unified tracing and TLS by default, full mesh routing with idempotency,
          retries and DLQ. One Go binary plus PostgreSQL — replaces Istio, RabbitMQ, Temporal and Jaeger.
        </motion.p>
